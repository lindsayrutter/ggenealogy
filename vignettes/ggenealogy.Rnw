...
% <<echo=false>>=
%\VignetteIndexEntry{Vignette: Grammar of graphics of genealogy (ggenealogy)}
...
<<label=plotAncDes1,include=FALSE, fig=TRUE>>=
...
\begin{figure} 
  \begin{center} 
<<label=plotAncDes1-1,echo=FALSE, fig=TRUE>>=
<<plotAncDes1>>
@ 
  \end{center} 
...
<<label=plotAncDes2, include=FALSE, fig=TRUE>>=
...
\begin{figure} 
  \begin{center} 
<<label=plotAncDes2-1,echo=FALSE, fig=TRUE>>=
<<plotAncDes2>>
@ 
  \end{center} 
...
<<label=plotPath, include=FALSE, fig=TRUE>>=
...
\begin{figure}[b!]
  \begin{center}
<<label=plotPath-1,echo=FALSE, fig=TRUE>>=
<<plotPath>>
@
  \end{center}
...
<<label=plotPath1, include=FALSE, fig=TRUE>>=
...
\begin{figure}[b!]
  \begin{center}
<<label=plotPath1-1,echo=FALSE, fig=TRUE>>=
<<plotPath1>>
@
  \end{center}
...
<<label=plotPath2, include=FALSE, fig=TRUE>>=
...
\begin{figure}[b!]
  \begin{center}
<<label=plotPath2-1,echo=FALSE, fig=TRUE>>=
<<plotPath2>>
@
  \end{center}
...
<<label=plotPathOnAll1,include=FALSE, fig=TRUE, warning=FALSE>>=
...
\begin{figure}[t!]
  % \begin{center}
<<label=plotPathOnAll1-1,echo=FALSE, warning=FALSE, fig=TRUE>>=
<<plotPathOnAll1>>
@
  % \end{center}
...
<<label=plotPathOnAll2, include=FALSE, warning=FALSE, fig=TRUE>>=
...
\begin{figure}[b!]
% \begin{center} 
<<label=plotPathOnAll2-1,echo=FALSE, warning=FALSE, fig=TRUE>>=
<<plotPathOnAll2>>
@ 
% \end{center} 
...
<<label=plotDegMatrix1, include=FALSE, warning=FALSE, fig=TRUE>>=
...
\begin{figure}[b!]
  \begin{center} 
<<label=plotDegMatrix1-1,echo=FALSE, warning=FALSE, fig=TRUE>>=
<<plotDegMatrix1>>
@ 
\end{center}
...
<<label=plotYearMatrix1, include=FALSE, warning=FALSE, fig=TRUE>>=
varieties=c("Brim", "Bedford", "Calland", "Narow", "Pella", "Tokyo", "Young", "Zane")
...
<<label=plotYearMatrix1-1,echo=FALSE, warning=FALSE, fig=TRUE>>=
<<plotYearMatrix1>>
@ 
%\end{adjustbox}
...
<<label=pathCB, include=FALSE, fig=TRUE>>=
...
%\centering
  %\begin{adjustbox}{width=5.4in,height=4.1in,clip,trim=0cm 1.5cm 0cm 1.5cm}
<<label=pathCB-1,echo=FALSE, fig=TRUE>>=
<<pathCB>>
@ 
  %\end{adjustbox}
