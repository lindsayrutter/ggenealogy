...
<<label=plotPathOnAll1,include=FALSE, warning=FALSE>>=
...
<<label=plotCBText, include=FALSE, warning=FALSE>>=
...
%\centering
  %\begin{adjustbox}{width=5.4in,height=4.1in,clip,trim=0cm 1.5cm 0cm 1.5cm}
<<label=plotCBText-1,echo=FALSE, warning=FALSE>>=
<<plotCBText>>
@ 
  %\end{adjustbox}
...
<<label=plotCBNoText, include=FALSE, warning=FALSE>>=
...
\centering
  %\begin{adjustbox}{width=5.4in,height=4.1in,clip,trim=0cm 1.5cm 0cm 1.5cm}
<<label=plotCBNoText-1,echo=FALSE, warning=FALSE>>=
<<plotCBNoText>>
@ 
  %\end{adjustbox}
...
<<label=plotAnimate, include=FALSE, eval=FALSE, warning=FALSE>>=
plotPathOnAll(pathCB, statGeneal, statIG, "gradYear", bin = 200, nodeSize = .5,
