---
title: "Getting started with the package **ggenealogy**"
...
There is a preprocessing pipeline to follow before visualizing your genealogical data. First, you must load the necessary libraries. Note that loading the ggenealogy library should automatically load several dependent libraries (ggplot2, igraph, plyr, reshape2): 
